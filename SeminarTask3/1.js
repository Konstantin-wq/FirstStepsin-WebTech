...
const celsiumTemperature = +prompt('Введите температуру в градусах Цельсия ');
const fahrenheitTemperature = calculateDegrees(celsiumTemperature);

alert(`Заданная температура ${celsiumTemperature} градусов по шкале Цельсия равняется ${fahrenheitTemperature} по шкале Фаренгейта`)


function calculateDegrees(x) {
    const result = ((9 / 5) * x + 32);
